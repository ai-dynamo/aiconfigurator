...
def _add_default_mode_arguments(parser):
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Enable wide expert-parallelism search space for large MoE models. "
        "Expands GPU-per-worker candidates to support EP up to 32/64.",
    )
...
def build_default_task_configs(
    ...
    Args:
        ...
        enable_wideep: Enable wide expert-parallelism search space for large MoE models.
