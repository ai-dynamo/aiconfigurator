...
def test_taskconfig_agg_default():
    task = TaskConfig(serving_mode="agg", model_path="QWEN3_32B", system_name="h200_sxm")
    cfg = task.config
...
def test_taskconfig_disagg_default():
    task = TaskConfig(serving_mode="disagg", model_path="QWEN3_32B", system_name="h200_sxm")
    cfg = task.config
...
def test_taskrunner_runs_agg_and_disagg():
    agg_task = TaskConfig(serving_mode="agg", model_path="QWEN3_32B", system_name="h200_sxm")
    disagg_task = TaskConfig(serving_mode="disagg", model_path="QWEN3_32B", system_name="h200_sxm", total_gpus=8)
