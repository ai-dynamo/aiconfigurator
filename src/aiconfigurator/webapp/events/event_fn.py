        ...
        with (
            ...
            try:
                ...
                model_config = config.ModelConfig(
                    ...
                    device=common.system_name_to_device(system_name),
        ...
        with (
            ...
            try:
                ...
                prefill_model_config = config.ModelConfig(
                    ...
                    device=common.system_name_to_device(prefill_system_name),
                ...
                decode_model_config = config.ModelConfig(
                    ...
                    device=common.system_name_to_device(decode_system_name),
