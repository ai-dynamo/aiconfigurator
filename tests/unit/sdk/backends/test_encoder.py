...
class TestEncoderMemoryInSummary:
    ...
    def test_vl_model_with_zero_image_dimensions_skips_encoder_memory(self, model_config):
        """Default zero image dimensions mean no image workload even when num_images defaults to 1."""
        from types import SimpleNamespace
        from unittest.mock import MagicMock
