    ...
    *,
    ...
    lines.extend(
        [
            ...
            "  barrier_port=29511",
            "  if (( node_rank == 0 )); then",
            "    python3 - \"$((node_count - 1))\" \"$barrier_port\" \"${FPM_COMPLETION_BARRIER_TIMEOUT_SECONDS:-180}\" <<'PY'",
            "import socket",
            "import sys",
            "import time",
            "",
            ...
            "PY",
            "  else",
            "    python3 - \"$master_addr\" \"$barrier_port\" \"$node_rank\" \"${FPM_COMPLETION_BARRIER_TIMEOUT_SECONDS:-120}\" <<'PY'",
            "import socket",
            "import sys",
            "import time",
            "",
