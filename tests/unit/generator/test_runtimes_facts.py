...
_OLD = Path(__file__).resolve().parents[3] / "src/aiconfigurator/generator/config/backend_version_matrix.yaml"
_NEW = Path(__file__).resolve().parents[3] / "src/aiconfigurator/generator/facts/runtimes/dynamo.yaml"
