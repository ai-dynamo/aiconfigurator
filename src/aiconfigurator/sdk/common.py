...
SupportedModels = {
    ...
    "QWEN3_32B": [
        ...
        0,
        0,
        {"use_qk_norm": True, "architecture": "Qwen3ForCausalLM"},
    ],  # qwen3 is not using hiddensize=headdim*numheads.
    "QWEN3_0.6B": ["LLAMA", 28, 16, 8, 128, 1024, 3072, 151936, 40960, 0, 0, 0, {"use_qk_norm": True, "architecture": "Qwen3ForCausalLM"}],
    "QWEN3_1.7B": ["LLAMA", 28, 16, 8, 128, 16 * 128, 6144, 151936, 40960, 0, 0, 0, {"use_qk_norm": True, "architecture": "Qwen3ForCausalLM"}],
    "QWEN3_8B": ["LLAMA", 36, 32, 8, 128, 32 * 128, 12288, 151936, 40960, 0, 0, 0, {"use_qk_norm": True, "architecture": "Qwen3ForCausalLM"}],
    "QWEN3_30B_A3B": ["MOE", 48, 32, 4, 128, 2048, 6144, 151936, 40960, 8, 128, 768, {"use_qk_norm": True, "architecture": "Qwen3MoeForCausalLM"}],
    "QWEN3_235B": ["MOE", 94, 64, 4, 128, 4096, 12288, 151936, 40960, 8, 128, 1536, {"use_qk_norm": True, "architecture": "Qwen3MoeForCausalLM"}],
    "QWEN3_480B": ["MOE", 62, 96, 8, 128, 6144, 8192, 151936, 262144, 8, 160, 2560, {"use_qk_norm": True, "architecture": "Qwen3MoeForCausalLM"}],
    "Nemotron_super_v1.1": [
        "NEMOTRONNAS",
        80,
        64,
