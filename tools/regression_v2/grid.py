...
"""Tier-1 sampling grid for the regression-v2 static baseline.

Everything here is harness *policy*, versioned together with the committed
baselines: changing any list below changes the baseline row set, which the
compare gate reports as added/removed rows and requires an explicit baseline
...
DEFAULT_BASELINE_DIR = REPO_ROOT / "tests" / "baselines" / "regression_v2"
