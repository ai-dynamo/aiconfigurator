...
| 1 | Parity smoke harness (`tests/integration/cross_package/test_engine_step_parity.py`) | landed; 164 surfaces hard-asserted |
| 2 | Benchmark harness (`tests/integration/cross_package/benchmark_engine_step.py`) | landed; reproducible p50/p90/p99 + speedup |
...
From `tests/integration/cross_package/benchmarks.md` ("After fix campaign
...
The full breakdown is in `tests/integration/cross_package/benchmarks.md` ("FFI overhead
...
- Smoke parity harness: `tests/integration/cross_package/test_engine_step_parity.py`.
- Benchmark harness: `tests/integration/cross_package/benchmark_engine_step.py`.
