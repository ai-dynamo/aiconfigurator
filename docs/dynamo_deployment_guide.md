...
cp -r ${your_save_dir}/QWEN3_32B_h200_sxm_trtllm_isl5000_osl1000_ttft1000_tpot50_*/backend_configs/* ./
...
```bash
cd /workspace/mount_dir/dynamo/components/backends/trtllm
cp -r QWEN3_32B_h200_sxm_trtllm_isl5000_osl1000_ttft200_tpot8_*/backend_configs/* ./
bash disagg/node_0_run.sh
```
