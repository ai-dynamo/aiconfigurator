...
```bash
aiconfigurator cli generate --model-path Qwen/Qwen3-32B --total-gpus 8 --system h200_sxm
```
...
**Required arguments:**
- `--model-path`: HuggingFace model path (e.g., `Qwen/Qwen3-32B`) or local path containing `config.json`
...
```bash
aiconfigurator cli support --model-path Qwen/Qwen3-32B --system h200_sxm
```
...
```bash
aiconfigurator cli default --model-path Qwen/Qwen3-32B --total-gpus 32 --system h200_sxm
or
aiconfigurator cli default --model-path Qwen/Qwen3-32B --total-gpus 32 --system h200_sxm --ttft 1000 --tpot 10 --isl 3000 --osl 512 --prefix 0
```
...
aiconfigurator cli default --model-path Qwen/Qwen3-32B --total-gpus 32 --system h200_sxm --backend trtllm

# Use vLLM (dense models only, currently being evaluated)
aiconfigurator cli default --model-path Qwen/Qwen3-32B --total-gpus 32 --system h200_sxm --backend vllm

# Use SGLang (dense and MoE models, currently being evaluated)
aiconfigurator cli default --model-path Qwen/Qwen3-32B --total-gpus 32 --system h200_sxm --backend sglang
```
...
Let's run `aiconfigurator cli default --model-path Qwen/Qwen3-32B --total-gpus 32 --system h200_sxm --ttft 1000 --tpot 10 --isl 3000 --osl 512 --prefix 0`
...
```bash
aiconfigurator cli default --model-path Qwen/Qwen3-32B --total-gpus 32 --system h200_sxm --database-mode HYBRID
```
