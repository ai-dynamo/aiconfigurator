...
# Experiment: GLM-5-FP8 disaggregated Pareto frontier on B200

This replay-backed sweep targets the InferenceX / SemiAnalysis (SA) **GLM-5-FP8 / B200 /
dynamo-sglang / 1k-1k / disagg** frontier. It tests whether Spica can discover competitive
...
The replay baseline uses SA's per-concurrency deployment mappings with the fixed AIC + Dynamo
...
| latest AIC + Dynamo replay baseline | 53,825 | 83.3% |
...
The runnable config is [glm5-disagg-pareto-frontier.yaml](glm5-disagg-pareto-frontier.yaml):
...
![GLM-5-FP8 B200 disaggregated Pareto frontier comparing Spica, the latest fixed replay baseline, and SemiAnalysis measured results.](glm5-disagg-pareto-frontier-sweep.png)
