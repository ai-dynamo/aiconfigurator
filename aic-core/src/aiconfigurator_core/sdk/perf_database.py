...
@functools.cache
def _load_perf_data_reuse_manifest_entries(systems_root: str) -> dict[str, tuple[dict, ...]]:
    """Load `<systems_root>/perf_data_reuse_manifest.yaml` and group entries by op_file.
    ...
    The manifest is generated by `tools/perf_database/generate_perf_data_reuse_manifest.py`.
    """
    manifest_path = os.path.join(systems_root, "perf_data_reuse_manifest.yaml")
...
class PerfDatabase:
    ...
    def __init__(
        ...
        self._perf_data_reuse_manifest_entries = _load_perf_data_reuse_manifest_entries(systems_root)
    ...
    def _build_op_sources(
        ...
        for entry in self._perf_data_reuse_manifest_entries.get(op_file_basename, ()):
