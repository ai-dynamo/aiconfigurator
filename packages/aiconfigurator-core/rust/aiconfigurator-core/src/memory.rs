...
//! `aiconfigurator_core.sdk.memory.estimate_kv_cache`. The Rust side:
//!
...
//! the docstring of `aiconfigurator_core.sdk.memory.estimate_kv_cache`. The
...
/// Python `aiconfigurator_core.sdk.memory.estimate_kv_cache` does the backend↔fraction
...
mod tests {
    ...
    // live entirely in Python (`aiconfigurator_core.sdk.memory.estimate_kv_cache`),
