...
//! crosses into Python once to run `aiconfigurator_core.sdk.engine.compile_engine`,
...
//! imports `aiconfigurator_core.sdk.engine`, which itself imports the maturin-built
