...
from aiconfigurator_core.sdk import config, perf_database, rust_engine_step
...
from aiconfigurator_core.sdk.operations import clear_all_op_caches
...
CASES = {
    ...
    # cross-package suite (`tests/integration/cross_package/test_engine_step_parity.py::SMOKE_CASES`)
    # where one exists so
