...
Examples:
  # closed-loop synthetic (in-flight concurrency cap)
...
import metrics
import workload
from vllm_sim import EngineArgs, Simulator, SyntheticPerfModel
...
def main() -> None:
    ...
    sim = Simulator(args.num_workers, engine_args, SyntheticPerfModel(), concurrency=args.concurrency)
