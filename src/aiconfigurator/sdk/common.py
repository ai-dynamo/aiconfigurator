...
class PerfDataFilename(Enum):
    ...
    context_mla_wideep = "context_mla_wideep_perf.txt"
    generation_mla_wideep = "generation_mla_wideep_perf.txt"
    mla_bmm = "mla_bmm_perf.txt"
    moe = "moe_perf.txt"
    context_moe = "context_moe_perf.txt"
    generation_moe = "generation_moe_perf.txt"
    context_mlp = "context_deepep_mlp_perf.txt"
    generation_mlp = "generation_deepep_mlp_perf.txt"
