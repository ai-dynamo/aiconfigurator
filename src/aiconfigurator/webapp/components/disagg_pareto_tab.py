    ...
    with gr.Tab("Disaggregation Pareto Estimation"):
        ...
        with gr.Row():       
            with gr.Column(elem_classes="config-column"):
                ...
                prefill_latency_correction_scale = gr.Number(value=1.0, label="Prefill latency correction scale", interactive=True)
            with gr.Column(elem_classes="config-column"):
                ...
                decode_latency_correction_scale = gr.Number(value=1.0, label="Decode latency correction scale", interactive=True)
