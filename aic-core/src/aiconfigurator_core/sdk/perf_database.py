...
class PerfDatabase:
    ...
    def query_wideep_moe_compute(
        ...
        """DEPRECATED tombstone for the retired measured expert-compute path."""
        self._query_shim_tombstone(
            "query_wideep_moe_compute",
            "Large-EP compute is modeled from stock moe_perf via ModeledEPMoE; "
            "evaluate MoEAllToAll + ModeledEPMoE as an op list.",
        )
    ...
    def moe_expert_compute_coverage(
        ...
        """Retired: modeled EP compute requires no separate coverage table."""
        return set()
