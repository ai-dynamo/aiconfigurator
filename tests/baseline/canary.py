...
CANARY_CASES: list[CanaryCase] = [
    ...
    CanaryCase(
        ...
        backend_version="0.20.1",
        params=_make_params(
            "deepseek-ai/DeepSeek-V4-Pro", "vllm", mode="agg", total_gpus=_TOTAL_GPUS, system_name=_SYSTEM
        ),
    ),
    CanaryCase(
        ...
        backend_version="0.5.11",
        params=_make_params(
            "deepseek-ai/DeepSeek-V4-Pro", "sglang", mode="agg", total_gpus=_TOTAL_GPUS, system_name=_SYSTEM
        ),
    ),
    ...
    CanaryCase(
        ...
        backend_version="1.3.0rc14",
        params=_make_params(
            "deepseek-ai/DeepSeek-V4-Pro", "trtllm", mode="disagg", total_gpus=_TOTAL_GPUS, system_name="b200_sxm"
        ),
    ),
    CanaryCase(
        ...
        backend_version="0.5.11",
        params=_make_params(
            "deepseek-ai/DeepSeek-V4-Pro", "sglang", mode="agg", total_gpus=_TOTAL_GPUS, system_name="gb200"
        ),
    ),
    ...
    CanaryCase(
        ...
        backend_version="1.3.0rc14",
        params=_make_params(
            "deepseek-ai/DeepSeek-V4-Pro", "trtllm", mode="disagg", total_gpus=_TOTAL_GPUS, system_name="gb200"
        ),
    ),
    ...
    CanaryCase(
        ...
        backend_version="0.20.1",
        params=_make_params(
            _MOE_MODEL, "vllm", mode="agg", total_gpus=_TOTAL_GPUS, system_name="gb200", transport="ib"
        ),
    ),
