...
from aiconfigurator_core.sdk import config, engine, perf_database
from aiconfigurator_core.sdk.backends.factory import get_backend
from aiconfigurator_core.sdk.models import get_model

# Reuse the co-located harness's case definitions and constants so this test
# tracks the same smoke matrix.
from tests.integration.cross_package.test_engine_step_parity import PARITY_RTOL, SMOKE_CASES, EngineStepParityCase

pytestmark = pytest.mark.integration


# The subset deliberately spans ALL THREE backends. The full
# `tests/integration/cross_package/test_engine_step_parity.py` harness runs over
# vllm + sglang + trtllm;
