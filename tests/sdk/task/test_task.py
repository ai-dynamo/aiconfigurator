...
def test_sglang_moe_configs():
    ...
    # Test 1: sglang + MoE + wide_ep + disagg
    task_wide_ep = TaskConfig(
        serving_mode="disagg",
        model_name="DEEPSEEK_V3",
        system_name="h200_sxm",
        backend_name="sglang",
    ...
    prefill_cfg = task_wide_ep.config.prefill_worker_config
    decode_cfg = task_wide_ep.config.decode_worker_config
    ...
    # Test 2: sglang + MoE (non-wide_ep) + disagg
    task_no_wide_ep = TaskConfig(
        serving_mode="disagg",
        model_name="DEEPSEEK_V3",
        system_name="h200_sxm",
        backend_name="sglang",
    ...
    prefill_cfg2 = task_no_wide_ep.config.prefill_worker_config
    decode_cfg2 = task_no_wide_ep.config.decode_worker_config
    ...
    # Test 3: trtllm + MoE + wide_ep (should use previous logic)
    task_trtllm_wide_ep = TaskConfig(
        serving_mode="disagg",
        model_name="DEEPSEEK_V3",
        system_name="h200_sxm",
        backend_name="trtllm",
    ...
    prefill_cfg3 = task_trtllm_wide_ep.config.prefill_worker_config
    decode_cfg3 = task_trtllm_wide_ep.config.decode_worker_config

    # Verify trtllm uses previous wide_ep logic
