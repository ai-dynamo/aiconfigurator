...
"""
Generate the op-kernel-source reuse manifest and optional shareability reports.
...
Usage:
    python3 tools/perf_database/generate_op_kernel_source_manifest.py \\
...
def render_manifest(summaries: list[dict]) -> str:
    ...
    lines: list[str] = [
        ...
        "#",
        "# How to regenerate:",
        "#   Generated by tools/perf_database/generate_op_kernel_source_manifest.py from the data tree —",
