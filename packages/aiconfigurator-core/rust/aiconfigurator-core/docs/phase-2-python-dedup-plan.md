...
- The 164-surface smoke harness (`tests/integration/cross_package/test_engine_step_parity.py`,
...
- Rewrite `tests/integration/cross_package/test_engine_step_parity.py` /
  `tests/integration/cross_package/test_compile_engine_parity.py` to
