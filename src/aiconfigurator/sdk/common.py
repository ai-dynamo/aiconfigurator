...
class PerfDataFilename(Enum):
    ...
    context_ds_mla = "context_ds_mla_perf.txt"
    generation_ds_mla = "generation_ds_mla_perf.txt"
    mla_bmm = "mla_bmm_perf.txt"
    moe = "moe_perf.txt"
    context_moe = "context_moe_perf.txt"
    generation_moe = "generation_moe_perf.txt"
    context_ds_mlp = "context_ds_mlp_perf.txt"
    generation_ds_mlp = "generation_ds_mlp_perf.txt"
