...
Usage:
    python3 tools/perf_database/audit_kernel_source.py \\
        --data-root packages/aiconfigurator-core/src/aiconfigurator_core/systems/data \\
        --out-json $TMPDIR/op-kernel-sources.json \\
        --out-md   docs/perf_database/op-kernel-sources.md \\
        --out-manifest packages/aiconfigurator-core/src/aiconfigurator_core/systems/op_kernel_source_manifest.yaml

The manifest lives under packages/aiconfigurator-core/src/aiconfigurator_core/systems/ so the SDK loader
(packages/aiconfigurator-core/src/aiconfigurator_core/sdk/perf_database.py) reads it as package data and decides,
...
def render_manifest(summaries: list[dict]) -> str:
    ...
    lines: list[str] = [
        ...
        "#",
        "# How it's used:",
        "#   packages/aiconfigurator-core/src/aiconfigurator_core/sdk/perf_database.py reads this file at PerfDatabase",
        ...
        "packages/aiconfigurator-core/src/aiconfigurator_core/systems/data/",
        "#   is added, removed, or has its kernel_source values changed:",
        "#",
        "#     python3 tools/perf_database/audit_kernel_source.py \\",
        "#         --data-root packages/aiconfigurator-core/src/aiconfigurator_core/systems/data \\",
        "#         --out-manifest "
        "packages/aiconfigurator-core/src/aiconfigurator_core/systems/op_kernel_source_manifest.yaml",
        "#",
        "# Schema (per group):",
...
def main() -> None:
    ...
    parser.add_argument(
        "--data-root",
        type=Path,
        default=Path("packages/aiconfigurator-core/src/aiconfigurator_core/systems/data"),
